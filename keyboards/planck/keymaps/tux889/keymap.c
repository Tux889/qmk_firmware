...
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, TO(_TUX), LOWER,  KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_TUX] = {
  ...
  {KC_NO, KC_NO, KC_NO, TO(_QWERTY), LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_NO, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2}
}
};
