...
[_QWERTY] = {
  ...
  {TO(_TUX),     KC_LCTL,  KC_LALT,  KC_LGUI,  LOWER,    KC_SPC,   KC_SPC,   RAISE,    KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT}
},
...
[_TUX] = {
  ...
  {TO(_QWERTY), KC_NO, KC_NO, KC_NO, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_NO, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2}
}
};
